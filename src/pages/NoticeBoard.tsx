...
export default function NoticeBoard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      {/* Header */}
      <header className="flex items-center justify-between flex-wrap gap-4 p-4 bg-white shadow mb-6">
        <SlArrowLeft className="absolute left-6 font-bold" />
        <div className="text-2xl font-bold pl-4">Notice Board</div>
      </header>

      <div className="w-full mb-4 relative">
        <GoSearch className="absolute left-3 top-2.5" />
        <Input placeholder="Search Keyword" className="pl-8 border-gray-200" />
      </div>
